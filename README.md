...
- [x] **Stores data in MongoDB** - It should store the score of the user. 
- [x] **Stores credentials in MongoDB** - Storing the usernames & passwords
...
- [x] **Application is fully functional** - Only in the loosest sense of the term. 
